...
<p align="center">
  <img width="600" src="https://github-stats-extended.vercel.app/api?username=CUinspace233&theme=jolly&show_icons=true&rank_icon=github&card_width=600&custom_title=CUinspace233%27s%20GitHub%20Stats&show=stars,commits,prs,prs_merged_percentage,issues,prs_reviewed,contribs" alt="GitHub Stats">
</p>

## About

I'm a Computer Science student at UNSW Sydney, graduating in June 2026. I build practical web apps and AI tooling across the stack, with Vue/React on the frontend, Python/FastAPI on the backend, and Docker in between.
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><code>Chrome Extension</code> <code>Manifest V3</code> <code>JavaScript</code> <code>CSS</code> <code>Google Fonts</code></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
